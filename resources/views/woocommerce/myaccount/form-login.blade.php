...
@endphp
    <div class="flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="rounded border mx-auto mt-4 shadow sm:w-full sm:max-w-xl">
            <!-- Tabs -->
            ...
            <div id="tab-contents" class="bg-white py-8 px-4 sm:px-10">
              <div id="login" class="p-4">
                ...
                <div class="mt-8">
                    <form class="space-y-6 mb-4" method="post">
                        ...
                        <button type="submit" class="w-full flex justify-center border border-transparent rounded-md shadow-sm font-medium text-white bg-black hover:bg-black focus:outline-none uppercase focus:ring-2 focus:ring-offset-2 px-6 py-3 focus:ring-black" name="login" value="@php(esc_attr_e( 'Login', 'woocommerce' ))">{{ __( 'Login', 'woocommerce' ) }}</button>
                    </form>
                </div>
              </div>
              <div id="register" class="hidden p-4">
                ...
                <div class="mt-8">
                    <form method="post" class="register space-y-6 mb-4 p-0 border-none">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="w-full flex uppercase justify-center border border-transparent rounded-md shadow-sm  font-medium text-white bg-black hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 px-6 py-3 focus:ring-black" name="register"
