<form role="search" class="w-full h-full flex items-center border border-gray-300 bg-white relative px-2" method="get"
  ...
  <input required class="w-full p-0 border-0 focus:ring-0 text-sm md:p-2 md:pl-0 md:text-base" name="s" id="search_input"
    class="" type=" search" placeholder="Search for articles" />
</form>
