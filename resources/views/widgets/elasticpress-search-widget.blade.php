<div x-data="elasticpressSearchWidget()" class="">
  ...
  <form id="elasticpress-search-widget" role="search" class="w-full h-full flex items-center lg:border" method="get" action="{{ esc_url(home_url('/')) }}">
    ...
    <div class="relative w-full">
      ...
      <input x-model="search" @input.debounce.150ms="inputChanged" @click.away="hide=true" @click="hide=false" autocomplete="off" class="w-full p-0 border-0 focus:ring-0 lg:p-2 lg:pl-0 lg:w-80" name="s" id="elasticpress-search-widget__input" class="" type="search" placeholder="Search for items or sellers" />
