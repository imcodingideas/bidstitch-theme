<div class=" flex space-x-4 h-full justify-center items-center">
  ...
  @if ($notifications)
    <a href="{{ $notifications }}" title="notifications" class="relative">
      ...
      <span class="-translate-y-2 absolute bg-yellow-400 leading-none p-1 right-0 rounded-3xl text-xs top-0 transform translate-x-2">
        {{ $notifications_count }}
      </span>
    </a>
  @endif
